 ...
 */
jOWL.getCORS = function(url, data, callback, type) {
    try {
...
jOWL.loadRemote = function(path, callback, options){
	var that = this;
	this.getCORS(path, function(xml){callback(that.parse(xml, options));});
};
